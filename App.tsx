    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full mx-auto transform transition-all scale-100">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={onConfirm} 
            className={`flex-1 py-2.5 px-4 text-white rounded-xl font-medium shadow-lg transition-colors ${
              isDestructive 
...
const App: React.FC = () => {
  ...
  const [transactions, setTransactions] = useState<TransactionRecord[]>(() => {
    const saved = localStorage.getItem('wechat_transactions_v2');
        ...
        <header className="mb-10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
                ...
                <label
                    htmlFor="file-upload"
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-white shadow-lg shadow-indigo-200 transition-all cursor-pointer ${
                        isProcessing ? 'bg-gray-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-0.5'
                    }`}
                >
