...
import { Calculator, CheckCircle, X, User, Users, Crown, FileInput, Save, Calendar, Ban, Split, Settings } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl flex flex-col md:flex-row overflow-hidden my-8">
        ...
        <div className="w-full md:w-5/12 bg-gray-900 p-4 flex items-center justify-center group relative">
          <img 
            src={imageUrl} 
            alt="Receipt" 
            className="max-h-[60vh] md:max-h-[80vh] object-contain rounded-lg shadow-lg" 
          />
           <a href={imageUrl} target="_blank" rel="noreferrer" className="absolute bottom-4 right-4 bg-black/50 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
             查看大图
           </a>
        </div>
